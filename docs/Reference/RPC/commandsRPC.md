...
| Operational State    | -operationalState | Enabled/Disabled boolean if AMT is Enabled for 13th Gen Raptor Lake (AMT 16.1) or newer devices. N/A and will not show data for lower generations/versions                            |
